    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Debit An Account</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('debit_account_api') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }} {{ session('error_transaction') ? ' has-error': '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @endif
                                @if (session('error_transaction'))
                                    <span class="help-block">
                                        <strong>{{ session('error_transaction') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
